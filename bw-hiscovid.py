...
def main():
 for i in range(len(countries)):
  ...
  plt.ylabel('score')
  if j==0:plt.plot(i.date[0:-2],i.score[0:-2],color='black',ls='-')
  if j==1:plt.plot(i.date[0:-2],i.score[0:-2],color='black',ls=':')
  if j==2:plt.plot(i.date[0:-2],i.score[0:-2],color='black',ls='--')
  if j==3:plt.plot(i.date[0:-2],i.score[0:-2],color='black',ls='-.')
